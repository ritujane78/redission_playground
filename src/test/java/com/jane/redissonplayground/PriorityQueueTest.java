...
import com.jane.redissonplayground.subscriptions.Category;
import com.jane.redissonplayground.subscriptions.PriorityQueue;
import com.jane.redissonplayground.subscriptions.UserOrder;
...
public class PriorityQueueTest extends BaseTest{
    private PriorityQueue priorityQueue;
        ...
        public void setup(){
            ...
            RScoredSortedSetReactive<UserOrder> sortedSet = this.client.getScoredSortedSet("user:order", new TypedJsonJacksonCodec(UserOrder.class));
        ...
        Flux.interval(Duration.ofSeconds(1))
                ...
                .doOnNext(i -> {
                    ...
                    Mono<Void> mono = Flux.just(u1, u2, u3, u4, u5)
                            .flatMap(u -> this.priorityQueue.add(u))
                            .then();
